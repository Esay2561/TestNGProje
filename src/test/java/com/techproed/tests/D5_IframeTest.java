...
public class D5_IframeTest {
    ...
    public void iframeTest1(){
        ...
        paragraf.clear();//send keys yapmadan once clear yazarsak Iframe iicini temizler
    ...
    public void iframeTest4(){
        ...
        //switchTO ile gecisyaptik driver.switchTo().frame(0);
        //driver.switchTo().defaultContent();
        //driver.switchTo().parentFrame();//


        driver.switchTo().frame(0);//i frame giecis yapiyoruz
        WebElement paragraf = driver.findElement(By.xpath("//p"));
        paragraf.clear();
        paragraf.sendKeys("Merhaba Iframe");
        driver.switchTo().defaultContent();//iframeden cikiyoruz  normal sayfaya donus yapiyor sayfanin basina
