...
public class D3_SoftAssertTest {
     /*
    ...
    public void test01(){
        ...
        SoftAssert softAssert = new SoftAssert();//verify denir nesne uretmemiz gerekiyor
        ...
        softAssert.assertAll(); // yukarıdaki yaptığımız tüm doğrulamalar icin bu yazilmali
