...
public class D17_FhcTripHotelCreateTest extends TestBase {
...
2 - FhcTripHotelCreateTest ---- TESTS paketinde
    ...
    */
    ...
    public void giris(){//once giris yapmmiz lazim onun icin giris metodunu kullandik
    ...
    public void aramaTesti(){
        giris();//giris icin metodu cagirdik

        FhcTripHotelCreatePage fhcTripHotelCreatePage=new FhcTripHotelCreatePage(driver);//nesne urettik parametreolarakdriveri gonderdik
        ...
        Select select = new Select(fhcTripHotelCreatePage.idgroup);//paremetre olarak dropdownweb elementi gonderdik
        select.selectByIndex(2);
        //fhcTripHotelCreatePage.submit.sendKeys(Keys.ENTER);
        fhcTripHotelCreatePage.submit.click();

        /*
        SMOKE TEST ALTINDA D18=D19 DERSI VAR

         FACEBOOKLOGINTEST D18
         FHCTRIPHOTELCREATETEST D19
         GLBTRADERTEST D20
